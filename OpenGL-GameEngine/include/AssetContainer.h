...
public:
    ...
    std::shared_ptr<Material> getMaterial(const std::string& key, const std::shared_ptr<Texture>& texture, int texUnit, float shininess = 32, float specularIntensity = 1.0f);
